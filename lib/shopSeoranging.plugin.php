...
class shopSeorangingPlugin extends shopPlugin
{
    protected $routing;
    protected $app_id;
    ...
    public function ranging()
    {
        ...
        $seoranginglinks_model->deleteAll();
        ...
        foreach($rows as $row) {
            ...
            for($i = 0; $i < $row['count']; $i++) {
                ...
                $seoranginglinks_model->insert($data);
            }
    ...
    public static function display()
    {
        ...
        $result = $seoranginglinks_model->getByField('page',$page);
        if($result) {
            $link = $app_settings_model->get(array('shop','seoranging'),'tpl_link');
